...
interface Fit-UnitrixLogoProps {
  size?: "xs" | "sm" | "md" | "lg" | "xl";
  showText?: boolean;
  showSubtext?: boolean;
  className?: string;
...
const Fit-UnitrixLogo = ({ size = "sm", showText = false, showSubtext = false, className = "" }: Fit-UnitrixLogoProps) => {
...
export default Fit-UnitrixLogo;
