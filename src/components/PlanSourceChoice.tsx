import { Zap, ArrowLeft, SlidersHorizontal } from "lucide-react";
...
const PlanSourceChoice = ({ type, onChooseAI, onChooseManual, onBack }: PlanSourceChoiceProps) => {
  ...
  const subtitle = isTreino
    ...
    : "Use a inteligência artificial para criar seu plano alimentar personalizado";
  ...
  return (
    <div className="space-y-6 animate-slide-up">
      ...
      <div className={`grid grid-cols-1 ${isTreino ? 'sm:grid-cols-2' : ''} gap-4 max-w-lg mx-auto pt-4`}>
        {/* AI Option */}
        <button
          onClick={onChooseAI}
        ...
        {/* Manual Guided Option (treino only) */}
