...
const PlanSourceChoice = ({ type, onChooseAI, onChoosePDF, onBack }: PlanSourceChoiceProps) => {
  ...
  const subtitle = isTreino
    ? "Escolha entre a inteligência artificial ou o plano do seu personal"
    ...
    <div className="space-y-6 animate-slide-up">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg mx-auto pt-4">
        ...
        >
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            {isTreino
              ? "Use o plano do seu personal trainer"
